    ...
    <div className="mt-5">
      <div className="bg-white w-full max-w-md rounded overflow-hidden p-4 mx-auto">
        ...
        <form className="grid gap-4 mt-5" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col gap-1">
            <label htmlFor="profile_pic">
              Photo:
              <div className="h-14 bg-slate-200 flex justify-center items-center border rounded hover:border-[#5b81a2] cursor-pointer">
            ...
            <input
              ...
              id="profile_pic"
              name="profile_pic"
              className="bg-slate-100 px-2 py-1 focus:outline-[#5b81a2] hidden"
        ...
        <p className="my-3 text-center">
          Already have an account? <Link to="/email" className="hover:text-[#5b81a2] font-semibold">Login</Link>
        </p>
      </div>
    </div>
  );
